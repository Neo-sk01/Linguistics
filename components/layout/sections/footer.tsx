    ...
    return (
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link href="/" aria-label="go home" className="mx-auto block text-center">
                    <Image 
                        src="/2.svg" 
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} IMPERIUM LINGUISTICS, All rights reserved</span>
            </div>
        </footer>
    )
}
        ...
        <footer className="py-8 md:py-12 border-t">
            <div className="mx-auto max-w-5xl px-6">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    <Link href="/" aria-label="go home" className="block text-center mb-4 md:mb-0">
                        <Image 
                            src="/2.svg" 
                            alt="IMPERIUM LINGUISTICS Logo" 
                            width={120} 
                ...
                <div className="mt-4 flex justify-center md:justify-end gap-4 text-sm">
                    <Link href="#" target="_blank" rel="noopener noreferrer" aria-label="X/Twitter" className="text-muted-foreground hover:text-primary block">
                ...
                <span className="text-muted-foreground block text-center text-xs mt-4"> © {new Date().getFullYear()} IMPERIUM LINGUISTICS</span>
            </div>
        </footer>
    )
}
