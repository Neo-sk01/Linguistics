          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-6">
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <a href="https://www.instagram.com/imperiumlingustics_official/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 p-2 text-blue-400 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="https://www.linkedin.com/company/102341300/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 p-2 text-blue-400 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
