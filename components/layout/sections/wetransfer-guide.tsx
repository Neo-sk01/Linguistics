...
export const WeTransferGuideSection = () => {
  return (
    <div className="bg-gradient-to-b from-[#101827] via-[#0d1424] to-[#0c1220] text-gray-100">
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(37,99,235,0.25),_transparent_50%)]" />
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="mb-3 inline-flex items-center rounded-full border border-blue-400/40 bg-blue-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-blue-200">
              WeTransfer Guide
            </span>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button asChild variant="ghost" size="lg" className="text-blue-200 hover:text-white">
                <Link href="/contact">
                  Talk to our team
                </Link>
              </Button>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <Card className="h-full border-blue-500/20 bg-[#111b2c]/70 text-gray-100">
                    <CardHeader className="flex flex-col space-y-4 pb-0">
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <span className="text-sm font-medium text-blue-200/80">Step {index + 1}</span>
                      </div>
                    ...
                    <CardContent className="space-y-3 text-sm text-gray-300">
                      ...
                      {step.helper && (
                        <p className="rounded-lg border border-blue-400/20 bg-blue-500/5 p-3 text-xs text-blue-100">
                          {step.helper}
                        </p>
                      )}
                    </CardContent>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {preparationTips.map((tip) => {
              ...
              return (
                ...
                >
                  <Card className="h-full border-blue-500/10 bg-white/5 text-gray-100">
      ...
      <section className="bg-[#0a101d] py-16">
            ...
            {supportHighlights.map((item) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <Card className="h-full border-blue-500/20 bg-[#0f1829]/80 text-gray-100">
                    <CardHeader className="flex flex-row items-start gap-3 pb-2">
                      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-500/10 text-blue-200">
                        <Icon className="h-5 w-5" />
                      </div>
                      <CardTitle className="text-lg text-white">
                        {item.title}
